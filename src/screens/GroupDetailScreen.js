...
//         if (groupData) {
//           setIsAdmin(groupData.admins?.includes(userId));
//           setIsCreator(groupData.creator === userId);
//         }
//       }
//     } catch (error) {
...
//       if (group) {
//         setGroupData(group);
//         setIsAdmin(group.admins?.includes(currentUserId));
//         setIsCreator(group.creator === currentUserId);
//       }
//     } catch (error) {
...
//     const isCurrentUser = member._id === currentUserId || member.id === currentUserId;
//     const isMemberAdmin = groupData.admins?.includes(member._id || member.id);
//     const isMemberCreator = groupData.creator === (member._id || member.id);
...
//             onPress={() => handleRemoveMember(member._id || member.id)}>
...
//             <View style={[styles.groupAvatar, {backgroundColor: route.params.chatColor}]}>
...
//               <View style={styles.settingLeft}>
//                 <Icon name="shield-checkmark" size={20} color={colors.gray6} />
...
//   const canEditInfo = () => {
//     if (groupData?.settings?.onlyAdminsCanEditInfo) {
//       return isAdmin;
//     }
//     return true;
//   };
...
//                   onPress={() => handleReportMember(reportingMember._id || reportingMember.id)}>
...
//         // Check if user is admin or creator
//         if (groupData) {
//           const isUserAdmin = groupData.admins?.includes(userId);
//           const isUserCreator = groupData.creator === userId;
...
//       if (group) {
//         setGroupData(group);
//         setNewGroupName(group.name); // Update the edit fields
...
//             adminId === userId || adminId._id === userId || adminId.id === userId
//           );
//           const isUserCreator = group.creator === userId || 
...
//       adminId === memberId || adminId._id === memberId || adminId.id === memberId
//     );
//     const isMemberCreator = groupData.creator === memberId || 
//                            groupData.creator?._id === memberId || 
//                            groupData.creator?.id === memberId;
