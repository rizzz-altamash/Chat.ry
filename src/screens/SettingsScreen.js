...
//       title: 'Chat Settings',
//       items: [
//         {icon: 'wallpaper', label: 'Chat Wallpaper', type: 'navigation'},
//         {icon: 'backup', label: 'Chat Backup', type: 'navigation'},
//         {icon: 'history', label: 'Chat History', type: 'navigation'},
//       ],
//     },
//     {
//       title: 'Privacy',
//       items: [
//         {icon: 'block', label: 'Blocked Contacts', type: 'navigation'},
//         {icon: 'visibility', label: 'Last Seen', type: 'navigation'},
//         {icon: 'photo', label: 'Profile Photo', type: 'navigation'},
//       ],
//     },
//   ];
